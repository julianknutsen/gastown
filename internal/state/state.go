...
// Package state provides global state management for the Gas Town enable/disable toggle,
// using XDG-compliant paths for persistent per-machine state storage.
package state
